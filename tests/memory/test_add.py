...
def test_consistant_insertion_time(memory_buffer_1e6):
    ...
    first_insertion = timeit.timeit(lambda: memory_buffer_1e6.add(1, 2, 3, 4, False, 0.5), number=1)
    ...
    last_insertion = timeit.timeit(lambda: memory_buffer_1e6.add(1, 2, 3, 4, False, 0.5), number=1)
