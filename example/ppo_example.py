...
def evaluate_ppo_network(env, agent, record, args, training_step=0, display=True):
    ...
    for total_step_counter in range(int(max_steps_training)):
        ...
        if done or truncated:
            ...
            if evaluate:
                ...
                evaluate_ppo_network(env, agent, record, args, training_step=total_step_counter, display=False)
                logging.info("--------------------------------------------")
                evaluate = False
