...
class DynaSAC_SAS_Immersive_Weight:
    ...
    def sampling(self, curr_states, curr_act, pred_means, pred_vars):
        """
        ...
        with torch.no_grad():
            ...
            for i in range(self.sample_times):
                ...
                if self.reweight_critic == 1:
                    ...
                    pred_rwd1 = self.world_model.pred_rewards(curr_states, curr_act, sample1i)
                    pred_rwd2 = self.world_model.pred_rewards(curr_states, curr_act, sample2i)
                    pred_rwd3 = self.world_model.pred_rewards(curr_states, curr_act, sample3i)
                    pred_rwd4 = self.world_model.pred_rewards(curr_states, curr_act, sample4i)
                    pred_rwd5 = self.world_model.pred_rewards(curr_states, curr_act, sample5i)
                    rs.append(pred_rwd1)
                    rs.append(pred_rwd2)
                    rs.append(pred_rwd3)
                    rs.append(pred_rwd4)
