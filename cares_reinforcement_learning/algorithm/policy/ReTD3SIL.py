...
from cares_reinforcement_learning.memory import SelfImitation
...
class ReTD3SIL:
    def __init__(
        ...
        self.clip = 1.0
        self.sil_buffer = SelfImitation(self.actor_net, self.critic_net,
                                              self.actor_net_optimiser, self.critic_net_optimiser,
                                              self.gamma, self.clip, self.device)
    ...
    def train_policy(self, memory:ManageBuffers, batch_size: int) -> None:
        ...
        # info["states_tensor"] = states
        # info["actions_tensor"] = actions
        # info["rewards_tensor"] = rewards
