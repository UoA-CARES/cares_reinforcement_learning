...
# Track the total average td_error and deviation from mean of the ensemble for each critic and use the one with the lowest score to update the actor only
