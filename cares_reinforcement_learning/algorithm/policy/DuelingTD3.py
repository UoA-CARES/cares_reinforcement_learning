    ...
    def train_policy(self, experiences):
        ...
        if self.learn_counter % self.policy_update_freq == 0:
            ...
            for target_param, param in zip(
                self.target_critic_net.agent_Q1.parameters(),
                self.critic_net.agent_Q1.parameters(),
            ):
            ...
            for target_param, param in zip(
                self.target_critic_net.agent_Q2.parameters(),
                self.critic_net.agent_Q2.parameters(),
            ):
                target_param.data.copy_(
                    param.data * self.tau + target_param.data * (1.0 - self.tau)
                )
            ...
            # Update target network params
            for target_param, param in zip(
                self.target_critic_net.environment_Q1.parameters(),
                self.critic_net.environment_Q1.parameters(),
            ):
                target_param.data.copy_(
                    param.data * self.tau + target_param.data * (1.0 - self.tau)
                )
            ...
            for target_param, param in zip(
                self.target_critic_net.environment_Q2.parameters(),
                self.critic_net.environment_Q2.parameters(),
            ):
                target_param.data.copy_(
                    param.data * self.tau + target_param.data * (1.0 - self.tau)
                )
