'''
This code is from
https://github.com/SonyResearch/simba/blob/master/scale_rl/agents/wrappers/utils.py

It provides the code to keep track of the running mean, variance and count of values.
'''
"""
