'''
Taken from https://github.com/SonyResearch/simba/blob/master/scale_rl/agents/wrappers/normalization.py
'''
...
from scale_rl.agents.base_agent import AgentWrapper, BaseAgent  #Change to CARES
from scale_rl.agents.wrappers.utils import RunningMeanStd  #Change to CARES
