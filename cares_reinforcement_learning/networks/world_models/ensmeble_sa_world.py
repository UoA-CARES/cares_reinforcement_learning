...
class EnsembleWorldAndOneSAReward:
    """
    Specifications:
    ...
    def pred_rewards(self, observation: torch.Tensor, action: torch.Tensor):
        pred_rewards = self.reward_network(observation, action)
        return pred_rewards
