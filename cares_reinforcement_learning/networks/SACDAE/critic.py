...
from cares_reinforcement_learning.networks.SACD import DefaultCritic as DefaultSACDCritic
...
class Critic(EncoderCritic):
    def __init__(self, observation_size: dict, num_actions: int, config: SACAEConfig):
        ...
        critic = SACDCritic(critic_observation_size, num_actions, config)
